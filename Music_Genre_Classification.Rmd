...
```{r}
#xgboost - tf
genres_xgboost_tf <- h2o.xgboost(y = "label", training_frame = genres_train_tf.hex, nfolds = 5, seed = 1234)
...
```{r}
#xgboost - reg
genres_xgboost_reg <- h2o.xgboost(y = "label", training_frame = genres_train_reg.hex, nfolds = 10, seed = 1234)
...
h2o.confusionMatrix(genres_dl_reg_m2)
